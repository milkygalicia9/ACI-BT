  ...
  <div class="carousel-inner">
                                ...
                                <div class="card info-card sales-card">
                                  ...
                                  <div class="filter" style="z-index: 10;">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                      ...
                                      <li><p class="dropdown-item" onclick="moreInfo('Business Permit (New)', 1)"
                                ...
                                <div class="card info-card revenue-card">
                                    ...
                                    <div class="filter" style="z-index: 10;">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                          ...
                                          <li><a class="dropdown-item" href="#">Show Info</a></li>
                                        </ul>
                                      </div>
    ...
    <div class="container-fluid col-lg-12">
        <div class="row">
          ...
          <div class="container-fluid col-md-12" style="overflow: hidden; height: 100%;">
